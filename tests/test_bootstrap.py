...
class RuntimeContractTests(unittest.TestCase):
    ...
    def test_tracked_runtime_state_declares_current_active_slot_contract(self) -> None:
        ...
        self.assertEqual(104, tracked["revision"])
        self.assertEqual("2026-09-06T06:30:00Z", tracked["updated_at"])
        self.assertEqual(
            "ce64936af8eabb669a63b7af54bb65977d014290516d8f9bab76a9c7f9812452",
        ...
        self.assertEqual(
            "fa2ee388-d8f7-4cb6-a2fc-1410b0b7e561",
        ...
        self.assertEqual("0.1.0-canary14", csr_successor["unit"]["version"])
        self.assertEqual(
            "4cd247732e39787fdafef9d9fa25a461b9665f0e",
            csr_successor["unit"]["source_commit"],
        )
        self.assertEqual(
            (
                "7c38c5f3-25f9-4d4a-9f16-1d41c88fa314",
                "container-slot-reservations-0.1.0-canary14.jar",
                "72b602c1fa781a53fecfbdfd58a3174ee85a910a7f0c099dcdd178c339d1f790",
                ["mod:container_slot_reservations"],
            ),
            (
        ...
        self.assertEqual("2026-09-06T06:30:00Z", slot_a["deployment"]["deployed_at"])
        self.assertEqual("2026-09-06T06:30:00Z", slot_a["deployment"]["ready_verified_at"])
        ...
        self.assertEqual({'unit': {'deployment_id': '03f7540f-94f0-47c5-b6bd-94f2af232ff4', 'project_uuid': 'ffa96cc6-2989-5465-b158-1659a484366b', 'project_id': 'quick-stack-nearby-compat', 'project_identity_source': 'CURRENT_MANIFEST', 'version': '0.1.0-canary9', 'source_commit': 'a333a4b5fa417cd9d35f6fc2608727828c23f6ea', 'artifacts': [{'artifact_id': '8b8abdf9-26a4-407c-bbd6-1623f0a5eeb5', 'kind': 'MOD', 'filename': 'quick-stack-nearby-compat-0.1.0-canary9.jar', 'sha256': '14a6844b04d9236233c7007ed111a452db659cc5662dca07aa11f33b2cb4ec76', 'ownership_keys': ['mod:quick_stack_nearby_compat'], 'source': {'type': 'REPOSITORY', 'path': 'projects/quick-stack-nearby-compat/artifacts/quick-stack-nearby-compat-0.1.0-canary9.jar'}}]}, 'replaces_accepted_deployment_id': '30a3d125-ecb6-4a7a-862b-ca2e2c1bbcfe', 'runtime_result': {'classification': 'INCONCLUSIVE', 'recorded_at': '2026-09-05T06:05:00Z', 'evidence': {'passed': ['Nested shulker routing using an internal CSR reservation worked.'], 'failed': []}}, 'accepted_companion_artifacts': [{'artifact_id': 'cb31d144-b6c4-41fb-ba44-35d896b228f6', 'kind': 'MOD', 'filename': 'quick-stack-nearby-0.4.0.jar', 'sha256': '43f1130527f782a291231c682791b4fd3766a20916c691cbdb98f91fdcc47e53', 'ownership_keys': ['mod:quick-stack-nearby'], 'source': {'type': 'ADOPTED_TARGET', 'path': 'mods/quick-stack-nearby-0.4.0.jar'}}]}, slot_b["members"][0])
        ...
        self.assertEqual(
            [
                "Baseline: Stack v19",
                "Slot A: Container Slot Reservations - Canary 14",
