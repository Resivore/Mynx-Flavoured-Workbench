...
$spread = Join-Path $root 'common\src\main\java\games\twinhead\moreslabsstairsandwalls\block\spreadable'
...
$mixin = Get-Content -Raw -LiteralPath (Join-Path $root 'common\src\main\java\games\twinhead\moreslabsstairsandwalls\mixin\SpreadableBlockMixin.java')
$checks = [ordered]@{
