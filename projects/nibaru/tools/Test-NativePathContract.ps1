...
$pathStairs = Get-Content -Raw -LiteralPath (Join-Path $projectRoot 'common\src\main\java\games\twinhead\moreslabsstairsandwalls\block\dirt\PathStairs.java')
$modelRoot = Join-Path $projectRoot 'common\src\main\resources\assets\more_slabs_stairs_and_walls\models\block'
