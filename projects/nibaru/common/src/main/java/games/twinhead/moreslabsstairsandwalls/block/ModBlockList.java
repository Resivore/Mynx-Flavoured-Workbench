...
public class ModBlockList {
    ...
    public static final ModBlock PODZOL = add(ModBlock.builder(Blocks.PODZOL).modelType(ModBlock.ModelType.GRASS).addBlockTags(BlockTags.DIRT, BlockTags.OVERRIDES_MUSHROOM_LIGHT_REQUIREMENT).build());
    public static final ModBlock MYCELIUM = add(ModBlock.builder(Blocks.MYCELIUM).modelType(ModBlock.ModelType.GRASS).addBlockTags(BlockTags.DIRT, BlockTags.OVERRIDES_MUSHROOM_LIGHT_REQUIREMENT).build());
