...
- Result: `PARKED` — Nibaru remains historical provenance with LGPL licensing and retained artifacts; future native-material and extended-geometry ownership belongs to unified BGE, no artifact was invalidated, and no independent testing plan remains.
- Next state: Use retained C45/C46 only for explicitly authorized rollback or reproduction, with all future validation routed through unified BGE.

## 2026-09-02T17:00:13Z — Remove standalone Nibaru from the live Stack under unified BGE ownership
- Revision: 7
- Source checkpoint: `27d9fc0f66fd32bcda8fef80cffd92ec5d964242`
- Changes: Manager revision 66 removes exact accepted standalone deployment `e5eb4fcb-6c49-4ab2-86f9-1605ccd192ab` from the live accepted Stack through the unified BGE artifact's ownership of the stable `more_slabs_stairs_and_walls` provider identity. Exact C45 accepted/rollback and C46 migration-baseline bytes and historical LGPL provenance remain tracked; no Nibaru artifact was rebuilt, repackaged, deleted, or replaced.
- Build/static: The retained build classification remains `CONTROLLED_VALIDATION_PASS`; this administrative retirement adds no new Nibaru build or static evidence and does not attest a new runtime dependency policy for the unchanged historical bytes.
- Runtime: No Nibaru deployment or runtime test was performed. The aggregate user-reported `PASS` is bound only to the exact BGE C58 and private Trowel C10/P9 deployment identities; it is not transferred to Nibaru, no checklist rows are inferred, and Nibaru remains `RUNTIME_UNTESTED`.
- Artifact: Current C46 `more-slabs-stairs-and-walls-4.2.0+26.2-port-canary46-bge-layer-contract.jar` embeds `4.2.0+26.2-port-canary46-bge-layer-contract`, SHA-256 `3281d110f062db62e721d838a35ce915ca73dd41af098a013b52952561ceae7d`, source `6e9b04ec3947f2514f90775bfeefb599242a4596`; historical accepted/rollback C45 `more-slabs-stairs-and-walls-4.2.0+26.2-port-canary43-native-directional-material-axis.jar` embeds `4.2.0+26.2-port-canary43-native-directional-material-axis`, SHA-256 `0a979a75101076e987a35807f8eb293631fe5e664b252e5db0aa263d4eedf07f`, source `2e58d752af44f4b84e10bc5e53a41aea00a177ee`.
- Result: `PARKED` — exact standalone accepted deployment removed from the live Stack while C45/C46 bytes and provenance remain tracked; `CONTROLLED_VALIDATION_PASS`, `NOT_DEPLOYED`, and `RUNTIME_UNTESTED` remain truthful.
- Next state: Preserve C45/C46 solely for explicitly authorized historical reproduction or rollback, with all active validation and release ownership routed through unified BGE.
