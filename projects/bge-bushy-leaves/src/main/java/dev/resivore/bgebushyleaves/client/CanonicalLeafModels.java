...
final class CanonicalLeafModels {
    private static final ReloadCache<BlockState, BlockStateModel> MODELS = new ReloadCache<>();
    ...
    static Optional<BlockStateModel> find(BlockState state) { return MODELS.find(state); }
}
