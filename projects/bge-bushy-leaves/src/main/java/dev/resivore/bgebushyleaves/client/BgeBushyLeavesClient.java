...
public final class BgeBushyLeavesClient implements ClientModInitializer {
    ...
    private static final Identifier BLOCK_SPACE_FOLIAGE_PHASE = Identifier.fromNamespaceAndPath(
            "bge_bushy_leaves", "block_space_foliage");
    ...
    public void onInitializeClient() {
        ModelLoadingPlugin.register(context -> {
            ...
            event.addPhaseOrdering(CANONICAL_APPEARANCE_CAPTURE_PHASE, BLOCK_SPACE_FOLIAGE_PHASE);
            ...
            event.register(BLOCK_SPACE_FOLIAGE_PHASE, (model, bakeContext) -> bakeContext.state() != null
