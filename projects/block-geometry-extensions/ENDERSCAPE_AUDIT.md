# Enderscape 3.0.2+mc26.2 material-behavior audit (C85)
...
C85 also verifies the exact canonical Veiled Leaves resource form: `assets/enderscape/items/veiled_leaves.json`
...
model-only form and retain the generated block/source-provider tint path when it does not.

| Source | Provider behavior | Classification | C85 disposition |
| --- | --- | --- | --- |
...
advertises the listed source-specific behavior. C85's GameTests construct every
