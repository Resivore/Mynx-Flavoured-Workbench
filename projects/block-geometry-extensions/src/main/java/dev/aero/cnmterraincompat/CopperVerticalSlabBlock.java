...
final class CopperVerticalSlabBlock extends ProviderVerticalSlabBlock
        implements ChangeOverTimeBlock<WeatheringCopper.WeatherState> {
    CopperVerticalSlabBlock(BlockBehaviour.Properties properties) { super(properties.randomTicks()); }
