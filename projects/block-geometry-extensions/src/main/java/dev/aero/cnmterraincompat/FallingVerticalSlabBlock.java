...
public class FallingVerticalSlabBlock extends ProviderVerticalSlabBlock implements Fallable {
 public FallingVerticalSlabBlock(Properties p){super(p);} @Override public void onPlace(BlockState s,Level l,BlockPos p,BlockState o,boolean n){FallingSemantics.schedule(l,p,this);}
