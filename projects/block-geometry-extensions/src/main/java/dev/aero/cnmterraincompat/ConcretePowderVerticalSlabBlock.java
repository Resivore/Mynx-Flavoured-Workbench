...
public final class ConcretePowderVerticalSlabBlock extends FallingVerticalSlabBlock {
 public ConcretePowderVerticalSlabBlock(Properties p){super(p);} private Block hardened(){return NibaruProviderAdapter.concreteHardening(this);}
