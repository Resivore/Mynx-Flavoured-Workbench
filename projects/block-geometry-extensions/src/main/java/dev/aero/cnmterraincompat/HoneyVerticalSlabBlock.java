...
final class HoneyVerticalSlabBlock extends ProviderVerticalSlabBlock {
    HoneyVerticalSlabBlock(BlockBehaviour.Properties properties) { super(properties); }

    @Override public VoxelShape getCollisionShape(BlockState state, BlockGetter level, BlockPos pos,
            CollisionContext context) {
        return HoneyDerivedGeometry.vertical(state);
    }
    ...
    @Override public void entityInside(BlockState state, Level level, BlockPos pos, Entity entity,
        ...
        HoneySemantics.applySlideIfEligible(state, level, pos, entity, HoneyDerivedGeometry.vertical(state));
