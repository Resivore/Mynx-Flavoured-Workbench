...
$profiles = Get-Content -Raw -LiteralPath (Join-Path $projectRoot 'src\nibaru\java\games\twinhead\moreslabsstairsandwalls\api\material\NibaruMaterialProfiles.java')
$profile = Get-Content -Raw -LiteralPath (Join-Path $projectRoot 'src\nibaru\java\games\twinhead\moreslabsstairsandwalls\api\material\NibaruMaterialProfile.java')
$blocks = Get-Content -Raw -LiteralPath (Join-Path $projectRoot 'src\nibaru\java\games\twinhead\moreslabsstairsandwalls\block\ModBlocks.java')
