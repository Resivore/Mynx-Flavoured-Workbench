...
$slab = Get-Content -LiteralPath (Join-Path $root 'src\nibaru\java\games\twinhead\moreslabsstairsandwalls\block\leaves\LeavesSlab.java') -Raw
$stairs = Get-Content -LiteralPath (Join-Path $root 'src\nibaru\java\games\twinhead\moreslabsstairsandwalls\block\leaves\LeavesStairs.java') -Raw
$semantics = Get-Content -LiteralPath (Join-Path $root 'src\nibaru\java\games\twinhead\moreslabsstairsandwalls\block\leaves\LeafSemantics.java') -Raw
$carrier = Get-Content -LiteralPath (Join-Path $root 'src\nibaru\java\games\twinhead\moreslabsstairsandwalls\block\leaves\LeafDistanceCarrier.java') -Raw
$modBlocks = Get-Content -LiteralPath (Join-Path $root 'src\nibaru\java\games\twinhead\moreslabsstairsandwalls\block\ModBlocks.java') -Raw
