...
public class KomodoDragon extends Animal implements SleepingAnimal, DataDrivenVariantAnimal {
    //region Data
    private static final java.util.function.Predicate<ItemStack> FOOD_ITEMS = stack -> stack.is(NaturalistTags.ItemTags.KOMODO_DRAGON_FOOD_ITEMS);
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, true,
                (entity, level) -> entity.is(NaturalistTags.EntityTypes.KOMODO_DRAGON_HOSTILES) && !this.isBaby()));
