...
public class Vulture extends PathfinderMob implements DataDrivenVariantAnimal {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, Monster.class, 10, false, false, (entity, level) -> entity.is(EntityTypes.VULTURE_HOSTILES) && !FOOD_ITEMS.test(this.getMainHandItem())));
    ...
    @Override
    protected void pickUpItem(@NotNull ServerLevel level, ItemEntity itemEntity) {
        ...
        if (!this.level().isClientSide() && this.isAlive() && this.isEffectiveAi()) {
            ...
            if (stack.get(DataComponents.FOOD) != null) {
                if (this.ticksSinceEaten > 600) {
                    ...
                    this.playSound(consumable != null ? consumable.sound().value() : SoundEvents.GENERIC_EAT.value(), 1.0f, 1.0f);
    ...
    static class VultureFleePlayerGoal extends Goal {
        ...
        public boolean canUse() {
            ...
            this.toAvoid = ((ServerLevel)this.vulture.level()).getNearestPlayer(this.fleeConditions, this.vulture);
    ...
    static class HighAltitudeFlyingWanderGoal extends FlyingWanderGoal {
        ...
        public Vec3 findPos() {
            ...
            if (preferredAltitude < 0 || wanderAttemptsUntilAltitudeChange <= 0) {
                ...
                int maxAltitude = Math.min(groundY + MAX_ALTITUDE_ABOVE_GROUND, level.getMaxY() + 1 - ALTITUDE_MARGIN_FROM_BUILD_LIMIT);
