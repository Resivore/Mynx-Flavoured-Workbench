...
public class CarriedFoodEntity extends ItemEntity {
    ...
    @Nullable
    private EntityReference<Ant> antReference;
    ...
    public void setAnt(Ant ant) {
        this.antReference = EntityReference.of(ant);
    ...
    public Ant resolveAnt() {
        ...
        Ant ant = EntityReference.get(this.antReference, this.level(), Ant.class);
        if (ant != null) {
            this.entityData.set(DATA_ANT_ID, ant.getId());
            return ant;
        }
    ...
    public void addAdditionalSaveData(@NotNull ValueOutput tag) {
        ...
        NaturalistEntityPersistence.saveReference(tag, "Ant", this.antReference);
    }

    @Override
    public void readAdditionalSaveData(@NotNull ValueInput tag) {
        super.readAdditionalSaveData(tag);
        this.antReference = NaturalistEntityPersistence.readReference(tag, "Ant");
    }
}
