...
public class Lizard extends TamableAnimal implements DyeableAnimal, FollowingPet, DataDrivenVariantAnimal {
    ...
    private static final java.util.function.Predicate<ItemStack> TEMPT_INGREDIENT = stack -> stack.is(NaturalistTags.ItemTags.LIZARD_TEMPT_ITEMS);
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.TEMPT_RANGE, 10.0D).add(Attributes.MOVEMENT_SPEED, 0.3f).add(Attributes.MAX_HEALTH, 8.0).add(Attributes.ATTACK_DAMAGE, 2.0);
    }
