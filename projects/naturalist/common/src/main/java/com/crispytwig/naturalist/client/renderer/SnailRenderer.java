...
public class SnailRenderer extends NaturalistMobRenderer<Snail> {
    ...
    @Override
    public @NotNull Identifier getTextureLocation(@NotNull Snail entity) {
    ...
    @Override
    protected void setupRotations(@NotNull NaturalistRenderState<Snail> state, @NotNull PoseStack poseStack, float bodyRot, float entityScale) {
