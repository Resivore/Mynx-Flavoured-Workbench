...
public class Alligator extends NaturalistAnimal implements EggLayingAnimal, HuntingAnimal, DataDrivenVariantAnimal {
    //region Data
    private static final java.util.function.Predicate<ItemStack> FOOD_ITEMS = stack -> stack.is(NaturalistTags.ItemTags.ALLIGATOR_FOOD_ITEMS);
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, false, (entity, level) -> !this.isBaby() && this.canHunt() && entity.is(NaturalistTags.EntityTypes.ALLIGATOR_HOSTILES)));
    }
