...
public class Piranha extends AbstractSchoolingFish implements DataDrivenVariantAnimal {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, WaterAnimal.class, 10, true, false, (entity, level) -> entity.is(NaturalistTags.EntityTypes.PIRANHA_HOSTILES)) {
            @Override
            public boolean canUse() {
                return !Piranha.this.isFollower() && super.canUse();
            }
    ...
    @Override
    public boolean hurtServer(@NotNull net.minecraft.server.level.ServerLevel level, @NotNull DamageSource source, float amount) {
