...
public class Turkey extends Animal implements DataDrivenVariantAnimal {
    //region Data
    private static final Predicate<ItemStack> FOOD_ITEMS = stack -> stack.is(NaturalistTags.ItemTags.TURKEY_FOOD_ITEMS);
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, false,
                (entity, level) -> entity.is(NaturalistTags.EntityTypes.TURKEY_HOSTILES)));
    }
