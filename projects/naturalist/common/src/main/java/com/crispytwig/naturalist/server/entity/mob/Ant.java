...
public class Ant extends TamableClimbingAnimal implements NeutralMob, Catchable, DataDrivenVariantAnimal {
    ...
    @Nullable
    private EntityReference<CarriedFoodEntity> carriedFoodReference;
    @Nullable
    ...
    public void addAdditionalSaveData(@NotNull ValueOutput compound) {
        ...
        NaturalistEntityPersistence.saveReference(compound, "CarriedFood", this.carriedFoodReference);
    ...
    public void readAdditionalSaveData(@NotNull ValueInput compound) {
        ...
        this.carriedFoodReference = NaturalistEntityPersistence.readReference(compound, "CarriedFood");
    ...
    public CarriedFoodEntity getCarriedFood() {
        ...
        if (this.carriedFood == null && this.carriedFoodReference != null && this.level() instanceof ServerLevel server) {
            CarriedFoodEntity item = EntityReference.get(this.carriedFoodReference, server, CarriedFoodEntity.class);
            if (item != null && item.isAlive() && !item.getItem().isEmpty()) {
                this.carriedFood = item;
            } else {
                this.carriedFoodReference = null;
            }
        }
    ...
    public boolean isCarriedFood(@NotNull ItemEntity item) {
        return this.carriedFoodReference != null
                && item instanceof CarriedFoodEntity carried
                && this.carriedFoodReference.matches(carried);
    }
    ...
    private void pickUpOneFood(@NotNull ItemEntity source) {
        ...
        this.carriedFoodReference = EntityReference.of(carried);
    ...
    private static class AntEnterHillGoal extends MoveToBlockGoal {
        ...
        protected boolean isValidTarget(@NotNull LevelReader level, @NotNull BlockPos pos) {
            EntityReference<LivingEntity> owner = this.ant.getOwnerReference();
            return AntHillBlock.canAntEnter(level, pos, owner != null ? owner.getUUID() : null);
        }
    }
    ...
    private static class AntStoreFoodGoal extends MoveToBlockGoal {
        ...
        protected boolean isValidTarget(@NotNull LevelReader level, @NotNull BlockPos pos) {
            EntityReference<LivingEntity> owner = this.ant.getOwnerReference();
            return AntHillBlock.canAntStore(level, pos, owner != null ? owner.getUUID() : null);
        }
    }
    //endregion
