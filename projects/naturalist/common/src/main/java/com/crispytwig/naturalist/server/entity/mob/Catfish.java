...
public class Catfish extends AbstractFish implements HuntingAnimal, DataDrivenVariantAnimal {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, WaterAnimal.class, 10, true, false, (entity, level) -> this.canHunt() && entity.is(NaturalistTags.EntityTypes.CATFISH_HOSTILES)));
    }
