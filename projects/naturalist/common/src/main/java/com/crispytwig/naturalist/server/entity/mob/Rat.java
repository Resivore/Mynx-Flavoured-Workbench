...
public class Rat extends TamableClimbingAnimal implements SleepingAnimal, FollowingPet, Catchable, DataDrivenVariantAnimal, ContainerBoundWorker {
    ...
    private static final Predicate<ItemStack> FOOD_ITEMS = stack -> stack.is(NaturalistTags.ItemTags.RAT_FOOD);
    ...
    public void addAdditionalSaveData(@NotNull ValueOutput compound) {
        ...
        NaturalistEntityPersistence.savePackedInventory(compound, "CarriedItems", this.carriedItems);
    ...
    public void readAdditionalSaveData(@NotNull ValueInput compound) {
        ...
        compound.getLong("Workstation")
                .ifPresentOrElse(packed -> this.setWorkstation(BlockPos.of(packed)), () -> this.setWorkstation(null));
        NaturalistEntityPersistence.loadPackedInventory(compound, "CarriedItems", this.carriedItems);
        ...
        if (this.isFood(stack)) {
            ...
            if (this.getHealth() < this.getMaxHealth()) {
                if (!this.level().isClientSide()) {
                    ...
                    this.playSound(consumable != null ? consumable.sound().value() : net.minecraft.sounds.SoundEvents.GENERIC_EAT.value(), 1.0F, 1.0F);
                }
                return this.level().isClientSide() ? InteractionResult.SUCCESS : InteractionResult.CONSUME;
            }
    ...
    private static class RatBegGoal extends Goal {
        ...
        public boolean canUse() {
            this.player = ((ServerLevel)this.rat.level()).getNearestPlayer(this.begTargeting, this.rat);
