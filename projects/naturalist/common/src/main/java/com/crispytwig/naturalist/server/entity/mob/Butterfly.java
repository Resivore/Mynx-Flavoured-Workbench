...
public class Butterfly extends NaturalistAnimal implements Catchable, DataDrivenVariantAnimal {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.TEMPT_RANGE, 10.0D).add(Attributes.MAX_HEALTH, 3.0D).add(Attributes.FLYING_SPEED, 0.6F).add(Attributes.MOVEMENT_SPEED, 0.3F);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new TemptGoal(this, 1.25D, stack -> stack.is(FLOWERS), false));
