...
public class TortoiseMaskLayer<M extends EntityModel<NaturalistRenderState<Tortoise>>>
        extends RenderLayer<NaturalistRenderState<Tortoise>, M> {
    ...
    public void submit(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int packedLight,
        ...
        submitNodeCollector.order(1).submitModel(
                this.getParentModel(), state, poseStack, RenderTypes.entityCutout(skin),
