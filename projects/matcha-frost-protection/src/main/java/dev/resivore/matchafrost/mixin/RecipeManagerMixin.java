...
import dev.resivore.matchafrost.BlessingRecipeEnforcer;
...
abstract class RecipeManagerMixin {
    ...
    @ModifyVariable(
            ...
            ordinal = 0,
            require = 1)
    private RecipeMap matchaFrost$enforceBlessingOfDemeter(RecipeMap resolved) {
        return BlessingRecipeEnforcer.enforce(resolved, this.registries);
    }
}
