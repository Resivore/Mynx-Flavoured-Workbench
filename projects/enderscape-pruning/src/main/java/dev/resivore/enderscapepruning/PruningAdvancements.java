...
public final class PruningAdvancements {
    private PruningAdvancements() {
    }
    ...
    public static Map<Identifier, Advancement> removeSuppressed(Map<Identifier, Advancement> resolved) {
        ...
        PruningContract.BLOCKED_ADVANCEMENT_IDS.forEach(id -> retained.remove(Identifier.parse(id)));
