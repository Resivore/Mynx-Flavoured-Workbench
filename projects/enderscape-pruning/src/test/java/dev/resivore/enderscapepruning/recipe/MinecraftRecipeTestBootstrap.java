...
/** Minimal Minecraft 26.2 bootstrap for component-backed recipe fixtures. */
public final class MinecraftRecipeTestBootstrap {
    private static boolean initialized;

    private MinecraftRecipeTestBootstrap() {
    }
