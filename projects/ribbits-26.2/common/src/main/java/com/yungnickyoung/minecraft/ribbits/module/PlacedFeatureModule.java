...
public class PlacedFeatureModule {
    ...
    public static final ResourceKey<PlacedFeature> SMALL_BROWN_TOADSTOOL_PATCH = ResourceKey.create(Registries.PLACED_FEATURE, RibbitsCommon.id("small_brown_toadstool_patch"));
