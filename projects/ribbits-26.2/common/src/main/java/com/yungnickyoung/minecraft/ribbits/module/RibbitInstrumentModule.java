...
public class RibbitInstrumentModule {
    ...
    public static final RibbitInstrument BASS = register("bass", "bass_ribbit", "play_bass", SoundModule.MUSIC_RIBBIT_BASS.get());
    public static final RibbitInstrument BONGO = register("bongo", "bongo_ribbit", "play_bongo", SoundModule.MUSIC_RIBBIT_BONGO.get());
    public static final RibbitInstrument FLUTE = register("flute", "flute_ribbit", "play_flute", SoundModule.MUSIC_RIBBIT_FLUTE.get());
    public static final RibbitInstrument GUITAR = register("guitar", "guitar_ribbit", "play_guitar", SoundModule.MUSIC_RIBBIT_GUITAR.get());
