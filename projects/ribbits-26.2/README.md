...
- Internal version: `4.1.6+26.2-mynx-canary6`
- Private artifact: `ribbits-private-reconstruction-4.1.6+26.2-mynx-canary6.jar`, 3,222,195 bytes, SHA-256 `CBEEDD06BAB0D6809FD528662E4C7E4F11E308F241D60FCE0D6AD0F57ADD0759`
- Source-only artifact: `ribbits-source-only-4.1.6+26.2-mynx-canary6.jar`, 1,162,715 bytes, SHA-256 `0EF6117836F9AE70354C9859236F1E38216411842A65941597C274CC008515F5`
...
Canary 6 succeeds, but does not overwrite or relabel, Canary 5: version `4.1.6+26.2-mynx-canary5`, private artifact `ribbits-private-reconstruction-4.1.6+26.2-mynx-canary5.jar`, 3,220,021 bytes, SHA-256 `0DDE14CAAF1EF1E4B52CA118D61E0ED0706BB0EAD4B718471CA3CC5B5A70BE4F`, source checkpoint `fb21c43d1f483108cbbb108d96213736db310e2b`. Canary 4, Canary 3, Canary 2, and the exact faithful-port baseline also remain historical at their recorded identities.
...
Canary 3 introduced, and Canary 6 preserves, two permanent, mechanically distinct Ribbits items:
...
Player-assigned custom entity names remain intact. Rank, XP, progression-gate completion, profession choices, Chef menu state, and daily restock state are saved with safe defaults when absent. There is deliberately no generalized migration of old serialized offer schemas; Canary 6 preserves Canary 5's recognition of only the exact saved Canary 3 Sorcerer offer shapes needed to insert its one new service without resetting existing offers or uses.
