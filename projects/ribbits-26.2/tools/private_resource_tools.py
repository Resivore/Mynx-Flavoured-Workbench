...
CANDIDATE_VERSION = "4.1.6+26.2-mynx-canary15"
CANDIDATE_CANARY = 15
...
PRIVATE_ARTIFACT_FILENAME = (
    "ribbits-private-reconstruction-4.1.6+26.2-mynx-canary15.jar"
)
SOURCE_ONLY_ARTIFACT_FILENAME = "ribbits-source-only-4.1.6+26.2-mynx-canary15.jar"
