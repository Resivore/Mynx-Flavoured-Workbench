...
The direct predecessor is Mynx Canary 10: `ribbits-private-reconstruction-4.1.6+26.2-mynx-canary10.jar`, 3,334,581 bytes, SHA-256 `3D0EA590BA7186FA1B1A7CF3A6BE7689EEF5C424275B19AACF5D6CF59945AED9`, source `681f120c444d2a0c34cfd1b448426f23cf9371bd`. It and earlier private artifacts remain unchanged and unaccepted.

Current successor `4.1.6+26.2-mynx-canary11` has its exact artifact/source identity in `WORKBENCH_STATUS.json` and the revision-16 log entry. It remains `ACTIVE / STATIC_PASS / NOT_DEPLOYED / RUNTIME_UNTESTED`.
...
- `ribbits:chute_leaf_open` still resolves through the existing item-definition and temporary `DataComponents.ITEM_MODEL` renderer contract. The packaged model is 1,796 bytes/SHA-256 `FFD3A9529B6B3067C4908353FDB3E25E19788F8B6CBA95BBB0F9F021EDF5FAB1`; both texture bindings resolve to the exact 6,233-byte donor entity texture/SHA-256 `8E481FA8B4E4458ADB52D60AB3123801E612835B65CD362264C00801D84D681A`. It contains no held-item `display`, `groups`, `texture_size`, or legacy custom-model contract.
- Inactive inventory art, `chute_leaf_closed`, closed chest/cape attachment, first-person callback/placement, `ChuteLeafRenderer`, registry/save ID, stack size, slot eligibility, input/acknowledgement/state, descent physics, Elytra conflicts, acquisition, durability and every Wandering/profession resource or behavior are unchanged. Minecraft runtime validation remains pending.
