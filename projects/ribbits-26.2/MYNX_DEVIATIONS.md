...
Current successor `4.1.6+26.2-mynx-canary13` has its exact artifact/source identity in `WORKBENCH_STATUS.json` and the revision-18 log entry. It remains `ACTIVE / STATIC_PASS / NOT_DEPLOYED / RUNTIME_UNTESTED`.
