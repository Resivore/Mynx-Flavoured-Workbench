...
Current successor `4.1.6+26.2-mynx-canary14` is a logging-only Wandering Ribbit scheduler diagnostic. Its exact artifact/source identity is in `WORKBENCH_STATUS.json` and the revision-19 log entry. It remains `ACTIVE / STATIC_PASS / NOT_DEPLOYED / RUNTIME_UNTESTED`.
