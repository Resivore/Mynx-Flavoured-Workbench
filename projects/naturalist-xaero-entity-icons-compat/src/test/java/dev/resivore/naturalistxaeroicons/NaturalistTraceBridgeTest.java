...
class NaturalistTraceBridgeTest {
    ...
    @Test void c34ChangesOnlyAdultWhaleFrameOffsetWhileKeepingC33sLiveBodyCenterAndAssembly() {
        ...
        var resolved = new NaturalistModelContracts.ResolvedContract(contract, body, selected, body);

        assertEquals(List.of("body"), contract.path());
        assertEquals(List.of("body"), contract.tracePath());
        assertTrue(contract.useTraceAsRenderCenter());
        assertTrue(resolved.selected().hasChild("skullRot"));
        ...
        assertEquals(-1.5F, contract.presentation().frameYOffset());
