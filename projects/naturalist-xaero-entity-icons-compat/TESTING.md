...
Canary 3 is `naturalist-xaero-entity-icons-compat-0.1.0-canary3.jar`, SHA-256
`510b205ce889ca92f31cf20a0eff078348598e3d6fef3cfeba15dc9363977d7b`, source
`831297c74ee4829563476b64d75e24d2342148f9`. Two clean offline Java 25 builds, JUnit contract/source/binary checks, and archive inspection are static evidence only. Canonical manager revision 117 has unrelated BGE C60 in Slot A and IBF C4 in Slot B. Do not displace either cohort; deploy C3 only through a future serialized free-slot transition in the dedicated Matcha Flavoured 26.2 Workbench.
...
Then verify Naturalist-derived icons rather than generic labels/markers for Anglerfish, Ray, Piranha, Bass, Hedgehog, Lizard, Giraffe, Jellyfish, Giant Isopod, Tortoise, Vulture, and Mole. Check adult/baby/state/variant model branches where Naturalist supplies them and repeat after resource reload.

Verify recognizable corrected geometry without unrelated body/limb leakage for Alligator (face rather than eyelids), Boar, Duck, Komodo Dragon (recognizable side-face), Rat, and Zebra (no nose overshoot). Verify Great White Shark is side-presented and reasonably sized; Desert Scorpion includes its abdomen; both scorpions remain recognizable; and Starfish is top-down with all legs visible.

Verify sensible Xaero icon scale for Blobfish, Clam, Dragonfly, Lion, Hippo, Mammoth, Elephant, Rhino, Great White Shark, Desert Scorpion, Jungle Scorpion, Ostrich, Tiger, Starfish, Whale, Zebra, and Brown Bear. Brown Bear must retain Xaero's working native model/texture capture while becoming sensibly sized.
