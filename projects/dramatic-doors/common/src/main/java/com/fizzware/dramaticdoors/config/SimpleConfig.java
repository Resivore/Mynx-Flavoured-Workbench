...
{
	private static final Path CONFIG_PATH = new File(System.getProperty("user.dir") + "/config").toPath();
	...
	public static ConfigRequest of(String filename) {
		return new ConfigRequest(CONFIG_PATH.resolve(filename + ".toml").toFile(), filename);
	}
