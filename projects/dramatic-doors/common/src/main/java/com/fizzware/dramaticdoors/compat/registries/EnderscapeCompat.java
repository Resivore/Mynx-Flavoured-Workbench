...
public class EnderscapeCompat
{
	...
	private static void registerBlocksItems() {
		...
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_MURUSHROOM, DDNames.SHORT_MURUSHROOM, DDRegistry.getBlockFromIdentifier(Identifier.fromNamespaceAndPath("enderscape", "murublight_door")), BlockSetType.WARPED, true);
	}
	...
	private static void registerRecipes() {
		...
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_MURUSHROOM, Identifier.fromNamespaceAndPath("enderscape", "murublight_door"), true);
		...
		DDCompatAdvancement.createRecipeAdvancement(DDNames.TALL_MURUSHROOM, Identifier.fromNamespaceAndPath("enderscape", "murublight_door"));
		...
		DDCompatRecipe.createShortDoorRecipe(DDNames.SHORT_MURUSHROOM, Identifier.fromNamespaceAndPath("enderscape", "murublight_door"), true);
		...
		DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_MURUSHROOM, Identifier.fromNamespaceAndPath("enderscape", "murublight_door"), "tall_wooden_door");
	}
}
