 ...
 * {@code arms_rotation} transform. C20 assumed that {@code VillagerModel.translateToArms}
 * supplied that child transform; C22 restores that assumption only as a diagnostic baseline.
 * This class supplies the reference group's authored local translation and no corrective pose.</p>
 */
public final class FrogVillagerRodPose {
    ...
    /** C20's intended unrotated shaft-tip vector under its analytical reference group. */
    ...
    /**
     * Converts C20's intended reference tip through its analytical adult Villager crossed-arms
     * transform. It is deliberately independent of the live renderer PoseStack so C22 can expose
     * the discrepancy without changing the existing line.
     */
