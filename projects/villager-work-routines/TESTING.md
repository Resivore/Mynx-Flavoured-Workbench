...
## Canary 10 client-start and Fisherman trial
...
Record **FAIL** for any startup/client crash, mixin application failure, `EntityRenderers` failure, VWR-caused resource-pack rollback, missing/duplicate/stale stick, a stick with a duplicate vanilla line/hook, a visible line-to-stick/bobber gap, moving/wandering during a live cast, absent/false barrel-deposit cue, fishing regression, line-geometry crash, legitimate-hand-state corruption, or Shepherd regression. Record **INCONCLUSIVE** only with the observed limiting condition. Do not mark C10 Fisherman PASS until a user observes the complete cycle.
