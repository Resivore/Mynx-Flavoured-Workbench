# Testing — BGE × Complementary Canary 2

## Current gate

**ACTIVE — STATIC_PASS — RUNTIME_UNTESTED**

Canary 2 is `bge-complementary-0.1.0+26.2-canary2.jar`, SHA-256
`5bded9c6b2a0d21e61ceeb6e6747084a667b6aa88f90a28993a598b2fe8537fa`.
...
placed BGE form. An absent or mismatched Iris/BGE version intentionally
produces no bridge hook.
...
| Explicit physical precedence | If a shader-pack test setup explicitly maps a BGE physical state or block, compare it to its canonical parent | The physical assignment remains visible; Canary 2 must not replace it. Record the temporary test arrangement without editing upstream/archive files. |
